...
var words = [
    ...
    {name: "острый", type: "прилагательное"},
    {name: "открытый", type: "прилагательное"},
    {name: "волшебный", type: "прилагательное"},
    {name: "удивленный", type: "прилагательное"},
];
...
document.getElementById("word-name").innerHTML = `Нарисуйте слово: `;
document.getElementById("inner_type").innerHTML = "";
...
if(event.target.className == "chose_btn"){
    ...
    time = setInterval(function(){
        document.getElementById("timer").innerHTML= `${i--} сек.`;
